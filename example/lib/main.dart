  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/defaultIcons": (context) => MyHomePage(
              title: "Default Icons",
              widget: DefaultIcons(),
            ),
        "/verticalAlignment": (context) => MyHomePage(
              title: "Vertically aligned",
              widget: VerticalAligned(),
            ),
        "/borderStyling": (context) => MyHomePage(
              title: "Border Styling",
              widget: BorderStyling(),
            ),
        "/colorStyling": (context) => MyHomePage(
              title: "Color Styling",
              widget: ButtonColors(),
            ),
        "/spacingElevation": (context) => MyHomePage(
